            ...
            <motion.div
                ...
                <div className="final-post-p-box">
                        ...
                        {isMobile && (<div className="final-post-p-u-d">
                            ...
                            <div className="final-post-p-u-d-right">
                                ...
                                <Tooltip title='Change'>
                                    <AutorenewIcon size="1.7rem" className='active' onClick={() => {
                                        if (type.startsWith("image")) {
                                            setShowCropper(true)
                    ...
                    {type.startsWith("video") && <video src={postdata} controls />} */}
                      ...
                      { isMobile && (   <div className="final-p-text-content" style={{ marginTop: isMobile && type.startsWith("video") ? '1rem ' : '' }}>
                  ...
                  {!isMobile && (   <div className="final-post-p-divice-two">
                       <div className="final-post-p-u-d">
                            <div className="final-post-p-u-d-out">
                            ...
                            <div className="final-post-p-u-d-right">
                                <Tooltip title=''>
                                    <AutorenewIcon size="2rem" style={{ cursor: 'pointer' }} className='active' onClick={() => {
                                        if (type.startsWith("image")) {
                                            setShowCropper(true)
